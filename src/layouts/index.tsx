      ...
      <div className="w-64 h-screen p-6 flex flex-col justify-between">
        <div className="space-y-4">
          ...
          <div className="bg-white/5 rounded-xl h-64 p-4 space-y-2">
            ...
            >
              ...
              <div className="text-sm pl-2">AR 增强现实</div>
            </Link>
            ...
            >
              ...
              <div className="text-sm pl-2">VR 虚拟现实</div>
            </Link>
            ...
            >
              ...
              <div className="text-sm pl-2">特征点工具</div>
            </Link>
            ...
            >
              ...
              <div className="text-sm pl-2">3D 模型库</div>
            </Link>
          </div>
        </div>
        ...
        <div className="rounded-xl p-4 space-y-2">
          ...
          >
            ...
            <div className="text-sm pl-2">废纸篓</div>
          </Link>
          ...
          >
            ...
            <div className="text-sm pl-2">更新日志</div>
          </Link>
          ...
          >
            ...
            <div className="text-sm pl-2">帮助 & 反馈</div>
          </Link>
        </div>
      </div>
